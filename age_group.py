...
def test_get_age_group():
    ...
    assert get_age_group(15) == 'unknown'
    assert get_age_group(24) == 'unknown'
    assert get_age_group(25) == 'unknown'
    assert get_age_group(64) == 'unknown'
    assert get_age_group(65) == 'unknown'
    assert get_age_group(80) == 'unknown'
